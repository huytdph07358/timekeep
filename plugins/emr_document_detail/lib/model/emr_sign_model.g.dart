...
EmrSignModel _$EmrSignModelFromJson(Map<String, dynamic> json) => EmrSignModel()
  ...
  ..COOR_Y_RECTANGLE = json['COOR_Y_RECTANGLE'] as String?
  ..COOR_X_RECTANGLE = json['COOR_X_RECTANGLE'] as String?
  ..PAGE_NUMBER = json['PAGE_NUMBER'] as String?
  ..MAX_PAGE_NUMBER = json['MAX_PAGE_NUMBER'] as String?
...
Map<String, dynamic> _$EmrSignModelToJson(EmrSignModel instance) =>
    <String, dynamic>{
      ...
      'COOR_Y_RECTANGLE': instance.COOR_Y_RECTANGLE,
      'COOR_X_RECTANGLE ': instance.COOR_X_RECTANGLE,
      'PAGE_NUMBER': instance.PAGE_NUMBER,
      'MAX_PAGE_NUMBER': instance.MAX_PAGE_NUMBER,
