...
class DocumentSignedScreen extends StatefulWidget {
  DocumentSignedScreen({super.key, this.option = 'creator'});

  String option = 'creator';

  @override
  State<DocumentSignedScreen> createState() => _DocumentSignedScreenState();
}

class _DocumentSignedScreenState extends State<DocumentSignedScreen> {
  @override
