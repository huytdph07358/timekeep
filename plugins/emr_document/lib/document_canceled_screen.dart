...
class DocumentCanceledScreen extends StatefulWidget {
  DocumentCanceledScreen({super.key, this.option = 'canceled'});

  String option = 'canceled';

  @override
  State<DocumentCanceledScreen> createState() => _DocumentCanceledScreenState();
}

class _DocumentCanceledScreenState extends State<DocumentCanceledScreen> {
  @override
