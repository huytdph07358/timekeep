...
abstract class Translate {
  ...
  /// No description provided for @cauHinh.
  ///
  /// In en, this message translates to:
  /// **'Config'**
  String get cauHinh;

  /// No description provided for @maBenhVien.
  ///
  /// In en, this message translates to:
  /// **'Hospital code'**
  String get maBenhVien;

  /// No description provided for @cauHinhHeThong.
  ///
  /// In en, this message translates to:
  /// **'Config system'**
  String get cauHinhHeThong;
