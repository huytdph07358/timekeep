...
abstract class Translate {
  ...
  /// No description provided for @fileVanBan.
  ///
  /// In en, this message translates to:
  /// **'Text file'**
  String get fileVanBan;

  /// No description provided for @khongTimThayFileVanBan.
  ///
  /// In en, this message translates to:
  /// **'Text file not found'**
  String get khongTimThayFileVanBan;
  ...
  /// No description provided for @kyVaGhiChu.
  ///
  /// In en, this message translates to:
  /// **'Sign & note'**
  String get kyVaGhiChu;
